...
- 次は **リリース**: README/CHANGELOG/Homebrew cask 雛形・`Scripts/notarize.sh` は用意済み。残りは人間ゲート（Apple Developer 加入後の署名・公証実行、GitHub Release 公開、cask tap、仮アイコンの最終判断）。ライセンス MIT 確定。
